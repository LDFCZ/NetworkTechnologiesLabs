package ru.nsu.ccfit.lopatkin.lab3.utils;

import javafx.application.Platform;
import javafx.scene.control.Button;
import javafx.scene.control.Label;
import ru.nsu.ccfit.lopatkin.lab3.services.GetDescriptionService;
import ru.nsu.ccfit.lopatkin.lab3.services.GetInterestingPlacesService;
import ru.nsu.ccfit.lopatkin.lab3.services.GetWeatherService;
    ...
    public ResultButton(String text, Context context, double lat, double lng) {
        ...
        this.setOnAction(actionEvent -> {
            ...
            CompletableFuture<Void> makeDescriptionRequest = CompletableFuture
                    .supplyAsync(new GetInterestingPlacesService(ResultButton.this.lat, ResultButton.this.lng))
