...
import ru.nsu.ccfit.lopatkin.lab3.utils.Context;
...
public class MainController {
    ...
    void searchRequest(KeyEvent event) {
        if (event.getCode().equals(KeyCode.ENTER)) {
            ...
            CompletableFuture<Void> makeRequest = CompletableFuture.runAsync(new GetLocationService(this.context, this.userInput.getText()));
        }
    }
