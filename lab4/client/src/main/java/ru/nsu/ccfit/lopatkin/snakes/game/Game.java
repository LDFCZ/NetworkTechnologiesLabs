...
import ru.nsu.ccfit.lopatkin.snakes.game.cell.Cell;
import ru.nsu.ccfit.lopatkin.snakes.game.cell.CellType;
...
import ru.nsu.ccfit.lopatkin.snakes.game.snake.Snake;
...
public class Game implements GameObservable {
    ...
    public Game(@NotNull GameState state) {
        ...
        gameObservers = new ArrayList<>();
        List<SnakeInfo> snakeInfos = state.snakeInfos();
        ...
        fruits = new ArrayList<>(state.fruits().size());
